...
narrativeRole: Opens on outcome-language tension — a lead came and went, unseen. No product yet.
keyMessage: Leads are visiting right now, and most go unnoticed.
...
narrativeRole: Names the real pain precisely — not "no leads," but leads with no usable information behind them.
keyMessage: A basic form collects contacts, not qualified leads.
...
narrativeRole: The turning point — resolves Frame 2's pain by naming the product. Section boundary (zoom-through).
keyMessage: This is the fix for the form problem just named.
...
narrativeRole: First proof beat — the form itself is the always-on worker, shown inside its real surface.
keyMessage: Always on, even when you're not.
...
narrativeRole: Proves "auto-qualifying" isn't abstract — shows the exact real fields doing the qualifying work.
keyMessage: The form gathers what you'd normally have to ask on a call.
...
narrativeRole: Closes the loop from form to booked call with zero manual follow-up.
keyMessage: No back-and-forth. Submission becomes a booked call automatically.
...
narrativeRole: Stacks the remaining benefits fast rather than slowing down for a fifth full beat — keeps pace toward the CTA.
keyMessage: The compounding payoff: better leads, less admin, more booked calls.
...
narrativeRole: Closing section boundary (zoom-through). Names the concrete offer and timeline, not just a generic "sign up."
keyMessage: This is available now, at a fixed price, delivered fast.
