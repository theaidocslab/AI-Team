 ...
 * Plugin URI: https://oborn.com
 * Description: Sovereign Entity JSON-LD + Bing IndexNow + Google Sitemap engine for Oborn Transfer & Storage. Standalone — does not modify the existing Oborn Transfer SEO plugin. Part of The Sovereign Stack™ by The AI Docs Lab™.
 * Version: 1.0.0
 * Author: Dr. Eric Townsend, PhD — The AI Docs Lab™ (Built for Oborn Transfer & Storage)
...
// ============================================================
// ACTIVATION — pre-populate all fields with Oborn's correct, verified data
// ============================================================
register_activation_hook(__FILE__, function() {
    $defaults = [
        // Core entity
        'aicrawler_schema_name'       => 'Oborn Transfer & Storage',
        'aicrawler_schema_type'       => 'StorageFacility',
        'aicrawler_owner_name'        => 'Bret Oborn',
        'aicrawler_website_url'       => 'https://www.oborn.com',
        'aicrawler_phone'             => '(801) 773-4902',
        'aicrawler_phone_tollfree'    => '1-800-358-0646',
        'aicrawler_email'             => 'Bret@oborn.com',
        'aicrawler_address'           => '1450 S. 13th Street, Building A-13N',
        'aicrawler_city'              => 'Clearfield',
        'aicrawler_state'             => 'UT',
        'aicrawler_zip'               => '84016',
        'aicrawler_country'           => 'US',
        'aicrawler_founded'           => '1969',
        'aicrawler_image'             => 'https://www.oborn.com/wp-content/uploads/2019/12/Red-Truck.jpg',

        // AEO/GEO content — written for AI crawlers, zero moving references
        'aicrawler_description'       => 'Oborn Transfer & Storage is a second-generation, family-owned secure freight storage and logistics facility based in Clearfield and Ogden, Utah, serving the Wasatch Front and businesses across the Western US since 1969. With over 90,000 square feet of secure storage across two locations and rare direct rail car access — the only facility in the region with this capability — Oborn specializes in secure freight storage, commercial warehousing, rail and intermodal logistics, cross-docking, and military and commercial contract storage. Local transfer service is also available.',
        'aicrawler_area'              => 'Wasatch Front, Utah — Clearfield, Ogden, and the greater Northern Utah region, with rail and trucking access across the Western US',
        'aicrawler_services'          => 'Secure Freight Storage, Rail Car Access, Commercial Warehousing, Cross-Docking, Intermodal Container Storage, Military and Commercial Contract Storage, Long-Term and Short-Term Storage, Bulk Materials Storage, Local Transfer Service',

        // sameAs — entity authority links
        'aicrawler_linkedin'          => '',
        'aicrawler_facebook'          => 'https://www.facebook.com/oborntransferandstorage/',
        'aicrawler_yelp'              => 'https://www.yelp.com/biz/oborn-transfer-and-storage-ogden',
        'aicrawler_bbb'               => '',
        'aicrawler_gbp'               => '',
        'aicrawler_instagram'         => '',
        'aicrawler_twitter'           => '@oborn',

        // Domain lock
        'aicrawler_licensed_domain'   => 'oborn.com',
...
function aicrawler_render_page() {
    ...
    if ($name)  { $score += 20; $checks[] = ['pass','✓','Business entity name set']; }
    if ($desc)  { $score += 25; $checks[] = ['pass','✓','AEO entity description set']; }
    ...
    <div class="acp-wrap">
        ...
        <div class="acp-body">
            ...
            <form method="post">
                ...
                <div class="acp-section">
                    ...
                    <div class="acp-entity-banner">
                        ⚡ Pre-loaded with Oborn's correct positioning: secure freight storage, rail car access, and warehousing — zero moving company language anywhere.
                    </div>
                    <div class="acp-grid">
                        <div class="acp-field">
                        ...
                        <div class="acp-field">
                            ...
                            <select name="aicrawler_schema_type">
                                <?php $type = get_option('aicrawler_schema_type', 'StorageFacility'); ?>
                    ...
                    <div class="acp-field">
                        ...
                        <textarea name="aicrawler_description"><?php echo esc_textarea(get_option('aicrawler_description')); ?></textarea>
                    </div>
                    <div class="acp-field">
                    ...
                    <div class="acp-grid">
                        <div class="acp-field">
                            ...
                            <input type="url" name="aicrawler_gbp" value="<?php echo esc_attr(get_option('aicrawler_gbp')); ?>" placeholder="Add once Bret's GBP is verified">
                        </div>
                        <div class="acp-field">
                ...
                <div class="acp-section">
                    ...
                    <div class="acp-field">
                        ...
                        <input type="text" name="aicrawler_licensed_domain" value="<?php echo esc_attr(get_option('aicrawler_licensed_domain')); ?>">
                    </div>
                </div>
                ...
                <div class="acp-section">
                    ...
                    <p style="font-size:12px;color:#666;margin:4px 0 0;">
                        Submit the sitemap URL above once in <a href="https://search.google.com/search-console" target="_blank">Google Search Console</a> → Sitemaps — now that oborn.com is verified, this can be submitted right away.
                    </p>
                </div>
            ...
            <div class="acp-sovereign">
                <p>⚡ Oborn Entity &amp; Crawler Pro™ — The Sovereign Stack™ | Built by The AI Docs Lab™ | theaidocslab.com</p>
            </div>
...
function aicrawler_build_schema($preview = false) {
    ...
    $type     = get_option('aicrawler_schema_type', 'StorageFacility');
...
// ============================================================
// ENTITY JSON-LD — fires sitewide, separate from the existing Oborn SEO plugin's output
// ============================================================
...
}, 100); // priority 100 — fires after the existing Oborn SEO plugin's own output, avoids collision
